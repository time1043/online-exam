  ...
  return (
    <>
      <DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
        ...
        <DropdownMenuContent align={align} sideOffset={sideOffset} className="max-w-svw min-w-64">
          {activeOrganization ? (
          ...
          {otherOrganizations.map((organization) => (
            <DropdownMenuItem key={organization.id} onSelect={() => handleSetActive(organization)}>
